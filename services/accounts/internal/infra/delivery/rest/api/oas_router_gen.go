	...
	default:
		...
		case '/': // Prefix: "/account"
			...
			if len(elem) == 0 {
				switch r.Method {
				case "GET":
					s.handleGetOwnInfoRequest([0]string{}, elemIsEscaped, w, r)
				case "POST":
			...
			case '/': // Prefix: "/"
				...
				case 'p': // Prefix: "password"
					...
					if len(elem) == 0 {
						...
						case "PUT":
							// Leaf: UpdatePassword
							r.name = "UpdatePassword"
							r.summary = ""
							r.operationID = "UpdatePassword"
							r.pathPattern = "/account/password"
							r.args = args
							r.count = 0
							return r, true
						default:
